...
Location.prototype.getArea = function (a, b, c) {
	//province
	console.log(this.items[0][a]);
	//city
	console.log(this.items['0,'+ a  ][b]);
	//area
	console.log(this.items['0,'+ a + ',' + b  ][c]);
}

Location.prototype.setArea = function (a, b, c) {
	$("#loc_province").select2("val", p);
	$("#loc_city").select2("val", ''+ a);
	$("#loc_town").select2("val", ''+ c);
}
